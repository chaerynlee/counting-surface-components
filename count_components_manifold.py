...
class SurfacetoOrbit:
    '''
    Constructs a general linear combination given a list of surfaces (will  be vertex surfaces of a certain face in an LW complex)
    ...
    def __init__(self, surface_list):
        ...
        self.vertex_surfaces = surface_list  # this is a regina normal surface
